...
public class TestBank2 {
    public static void main(String[] args) {
        ...
        Bank.Tabungan tabungan1 = b.new Tabungan(100000);
        b.tambahNasabah("Mikasa", "Akcerman", tabungan1);
        
        Bank.Tabungan tabungan2 = b.new Tabungan(50000);
        b.tambahNasabah("Hanji", "Zoe", tabungan2);
        
        Bank.Tabungan tabungan3 = b.new Tabungan(80000);
        ...
        if(hasilcari1 != -1){
            Bank.Nasabah nasabah = b.getNasabah(hasilcari1);
        ...
        if(hasilcari.length > 0){
            ...
            for(int i=0; i<hasilcari.length; i++){
                Bank.Nasabah nasabah = b.getNasabah(hasilcari[i]);
