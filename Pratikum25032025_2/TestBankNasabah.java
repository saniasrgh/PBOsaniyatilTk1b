...
public class TestBankNasabah {

    public static void main(String[] args) {
       Bank bank = new Bank();
    
        //membuat objek nasabah pertama
        Nasabah eren = new Nasabah("Eren", "Yeager");
        Tabungan tabungan1 = new Tabungan(500000);
        eren.settabungan(tabungan1);
    
        //membuat objek nasabah kedua
        Nasabah sania = new Nasabah("Sania", "Saragih");
        Tabungan tabungan2 = new Tabungan(600000);
